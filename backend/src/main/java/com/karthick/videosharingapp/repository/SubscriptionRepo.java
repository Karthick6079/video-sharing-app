...
public interface SubscriptionRepo extends MongoRepository<Subscription, String> {
    ...
    List<Subscription> findByChannelId(String userId); // Who I subscribed To  or Fetch given user subscribed channel list

    List<Subscription> findBySubscriberId(String userId); // Who subscribed to me or Fetch list of subscribers for given user
